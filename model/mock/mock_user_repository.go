...
// Source: github.com/rhtyx/bayarind-service.git/model (interfaces: UserRepository)
//
...
func (m *MockUserRepository) Update(arg0 context.Context, arg1 *model.User) (*model.User, error) {
	m.ctrl.T.Helper()
